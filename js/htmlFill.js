if (document.querySelectorAll("#nav")) {
	document.querySelectorAll("#nav").innerHTML += `
...
document.querySelectorAll('.iconGlobe').forEach(x => {x.innerHTML += `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
